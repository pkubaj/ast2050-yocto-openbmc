# This revision is based on the upstream tag "v2.6.30.10"
# We use the revision in order to avoid having to fetch it from the repo during parse
SRCREV = "846e3fb9a415b51c2859230acc681429853dc091"

SRC_URI = "git://github.com/pkubaj/ast2050-linux-kernel.git;protocol=https;branch=linux-2.6.30.10"
...
# 'include/generated', which doesnot match 2.6.30, where the file is in
# 'include/linux'.
